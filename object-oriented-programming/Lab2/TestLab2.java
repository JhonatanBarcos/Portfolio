...
public class TestLab2 {
    public static void main(String[] args) {
        ...
        //Create league instances
        System.out.println("\n==================================");
        System.out.println("Create Male Spain League");
        System.out.println("==================================");
        League mlSpLg = new League("Male Spain League", spain, League.Gender.Male);
        //Add teams to the league
        mlSpLg.addTeam(spainMaleTeam1);
        mlSpLg.addTeam(spainMaleTeam2);

        System.out.println("\n==================================");
        System.out.println("Try to create Male League with Male/Female Teams");
        System.out.println("==================================");
        League mlFrLg = new League("Male France League", france, League.Gender.Male);
        //Add teams to the league
        mlFrLg.addTeam(franceMaleTeam);
        mlFrLg.addTeam(franceFemaleTeam1);

        System.out.println("\n==================================");
        System.out.println("Try to create Male League with Spain/France Teams");
        System.out.println("==================================");
        League mlFrSpLg = new League("Male France League", france, League.Gender.Male);
        //Add teams to the league
        mlFrSpLg.addTeam(franceMaleTeam);
        mlFrSpLg.addTeam(spainMaleTeam1);

        System.out.println("\n==================================");
        System.out.println("Create Mixed France League");
        System.out.println("==================================");
        League mxFrLg = new League("Mixed France League", france, League.Gender.Mixed);
        //Add teams to the league
        ...
        //Generate matches
        System.out.println("\n==================================");
        System.out.println("Generate and simulate matches of each valid league");
        System.out.println("==================================");
        mlSpLg.generateMatches();
        mlSpLg.simulateMatches();
        mlSpLg.printMatches();
        

        System.out.println("\n==================================");
        System.out.println("Stats of 'france Male Team' and his players before Mixed France League");
        System.out.println("==================================");  
        ...
        mxFrLg.printMatches();
            ...
            System.out.println("\n==================================");
        System.out.println("Stats of 'france Male Team' and his players after Mixed France League");
        System.out.println("==================================");  
        franceMaleTeam.printStats();      
        franceMaleTeam.printPlayers();
        for (Player p : franceMaleTeam.getPlayers()) {
